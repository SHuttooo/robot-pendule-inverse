...
**Un robot à deux roues qui tient debout, d'abord avec un double PID réglé à la
main, puis avec un réseau de neurones entraîné en simulation et exécuté sur
l'ESP32.**
...
commande, contre 893 pour l'ancien. **La comparaison chiffrée avec le double
PID sur le matériel reste à faire.**
...
python 08_agent.py --duel               agent contre double PID
