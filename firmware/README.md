...
> désactivée quand l'agent pilote. Armer la cascade **une minute avant** de
...
| `7` | balayage de 0,5 à 20 Hz en 5 s, injecté sur l'accélération. Le robot vibre sur place. Cascade armée d'abord (`1` puis `K`). |
| `9` | balayage de 0,2 à 3 Hz en 5,5 s sur la consigne d'angle, amplitude 1°. Le robot se dandine sur environ 2 cm. |
| `0` | avance d'environ 10 cm après 1 s de repos, enregistrée, puis revient seul. Cascade armée d'abord. |
