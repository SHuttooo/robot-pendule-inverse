...
|---|---|---|
| `robot-avant.log` | jusqu'au 28 août | la mise au point du double PID (carnet) |
...
Le détail de chaque champ est dans [`firmware/README.fr.md`](../firmware/README.fr.md#télémétrie).
